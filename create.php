...
if (isset($_POST['submit'])) {
   ...
   if ($_POST["idno"] == $_POST["idno"]) {
      echo "Id Number aleady exist!!";
      $_SESSION['error_message'] = "Id Number aleady exist!!";
   ...
   <div class="container">
      ...
      <form method="POST" id="usersForm" onsubmit="return validateForm()" name="enqueryForm">
         <div class="form-group">
            ...
            <input type="date" id="dateofbirth" value="<?php //echo $date;
                                                         ?>" class="form-control" name="dob" min="1905" max="2000" placeholder="dd-mm-YYYY">
            <br>
